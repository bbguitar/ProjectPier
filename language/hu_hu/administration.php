<?php
  ...
  return array(
    ...
    'administration tool desc test_mail_settings' => 'Ezzel az egyszerű eszközzel próbaemaileket küldhet az activeCollab postázója megfelelő beállításainak ellenőrzéséhez',
    'administration tool name mass_mailer' => 'Csoportos levélküldő',
    'administration tool desc mass_mailer' => 'Egyszerű eszköz, mellyel egyszerű szöveg formátumú üzenetet küldhet a rendszerbe regisztrált bármelyik felhasználócsoportnak',
    ...
    'config category desc mailing' => 'Ezzel a beállításhalmazzal határozhatja meg, hogy az activeCollab hogyan kezelje az emailküldést. Használhatja a php.ini fájlban lévő konfigurációs lehetőségeket, vagy megadhatja bármilyen másik SMTP kiszolgáló adatait',
    ...
    'config option desc file_storage_adapter' => 'Válassza ki, hogy hol kívánja tárolni a mellékleteket, az avatarokat, az emblémákat és más feltöltött dokumentumokat. <strong>Az adatbázis tárolómotor ajánlott</strong>.',
    ...
    'config option desc theme' => 'A témák használatával megváltoztathatja az activeCollab alapértelmezett arculatát',
    ...
    'config option desc exchange_compatible' => 'Microsoft Exchange Server használata esetén néhány ismert postázási probléma elkerülése végett állítsa Igenre ezt a lehetőséget.',
    'config option name mail_transport' => 'Levélátvitel',
    'config option desc mail_transport' => 'Használhatja az alapértelmezett PHP beállításokat az emailek küldéséhez, vagy megadhatja az SMTP kiszolgáló adatait',
