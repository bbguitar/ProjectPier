<?php
  ...
  return array(
    ...
    'timezone gmt -8'   => '(GMT-8:00) Pacific Time (USA & Kanada)',
    'timezone gmt -7'   => '(GMT-7:00) Mountain Time (USA & Kanada)',
    'timezone gmt -6'   => '(GMT-6:00) Central Time (USA & Kanada), Mexico City',
    'timezone gmt -5'   => '(GMT-5:00) Eastern Time (USA & Kanada), Bogota, Lima, Quito',
    ...
    'timezone gmt +1'   => '(GMT+1:00) Amsterdam, Berlin, Rom, Köpenhamn, Bryssels, Madrid, Paris',
    'timezone gmt +2'   => '(GMT+2:00) Aten, Istanbul, Minsk, Helsingfors, Jerusalem, Sydafrika',
    'timezone gmt +3'   => '(GMT+3:00) Baghdad, Kuwait, Riyadh, Moskva, St. Petersburg',
