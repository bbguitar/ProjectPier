<?php
  ...
  return array(
    ...
    // Registration form
    'terms of services not accepted' => 'A fiók létrehozásához el kell olvasnod, és el kell fogadnod a szolgáltatási feltételeinket',
    ...
    // Login form
    'username value missing' => 'Kérjük, hogy írd be a felhasználónevedet',
    'password value missing' => 'Kérjük, hogy írd be a jelszavadat',
    'invalid login data' => 'A bejelentkezésed sikertelen. Kérjük, hogy ellenőrizd a bejelentkezési adataidat, és próbáld újra',
    ...
    'project form select message' => 'Kérjük, hogy válaszd ki az üzenetet',
    'project form select task lists' => 'Kérjük, hogy válaszd ki a feladatlistát',
    
    // Submit project form
    'form content required' => 'Kérjük, hogy szúrd be a tartalmat a szöveg mezőbe',
    ...
    'folder id required' => 'Kérjük, hogy válaszd ki a mappát',
    ...
    'massmailer select recepients' => 'Kérjük, hogy válaszd ki azokat a felhasználókat, akik ezt az emailt fogják kapni',
