<?php
  ...
  return array(
    'new projectpier version available' => 'Une nouvelle version d\'ProjectPier est disponible. <a href="%s">Plus d\'informations</a>.',
    ...
    'primary im description' => 'Toutes les adresses de messagerie instantanée saisies seront listéess sur la fiche de l\'Utilisateur. Seule l\'adresse de messagerie instantanée préférée sera affichée sur les autres pages (comme la page participants).',
    ...
    'back to configration' => 'Retour à la configuration',
    
    // Upgrade
    'upgrade is not available' => 'Il n\'y a pas de nouvelle version d\'ProjectPier à télécharger.',
    ...
    // Dashboard
    'welcome to new account' => 'Bienvenue dans le compte nouvellement créé',
    'welcome to new account info' => '%s, bienvenue dans votre nouveau compte. Il sera toujours disponible à partir de maintenant à l\'URL %s (vous pouvez ajouter ce lien aux Favoris). Vous pouvez commencer à utiliser ProjectPier en quelques minutes en suivant ces 4 étapes simples:',
    ...
    'new account step2 info' => 'Vous pouvez <a href="%s">Créez des comptes utilisateurs</a> pour tous les membres de votre équipe (nombre illimité). Chaque tuilisateur aura un login et un mot de passe pour accéder au système.',
